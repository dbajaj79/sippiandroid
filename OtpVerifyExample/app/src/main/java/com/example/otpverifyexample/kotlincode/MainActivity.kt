...
import com.example.otpverifyexample.MySMSBroadcastReceiver
import com.example.otpverifyexample.R
...
class MainActivity() : AppCompatActivity(), GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, SMSBroadCastReciever.OTPReceiveListener {


    var mCredentialsApiClient: GoogleApiClient? = null
    private val KEY_IS_RESOLVING = "is_resolving"
    private val RC_HINT = 2
    private var otpReceiver:SMSBroadCastReciever.OTPReceiveListener = this
    lateinit var otpTxtView: TextView

    val smsBroadcast = SMSBroadCastReciever()
